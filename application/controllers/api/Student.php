...
class Student extends REST_Controller{
  ...
  */
  ...
  public function index_post(){
    ...
    $name = $this->security->xss_clean($input_data['name']);
    $email = $this->security->xss_clean($input_data['email']);
    $mobile = $this->security->xss_clean($input_data['mobile']);
    $course = $this->security->xss_clean($input_data['course']);
